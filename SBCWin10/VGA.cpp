...
bool CVGAApp::ReadXML()
{
	...
	if( !F.Open(_T("C:\\Program Files (x86)\\Branson\\2000Xc\\Main.gui"), CFile::modeRead)) 
	{	
		return false;
	}
...
{
	CString name="C:\\Program Files (x86)\\Branson\\2000Xc"/*+\\languages\\")*/+Str;

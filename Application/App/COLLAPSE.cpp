/* $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/2000XWC/App/COLLAPSE.cpp_v   1.18   Nov 06 2017 09:54:12   RJamloki  $ */
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/2000XWC/App/COLLAPSE.cpp_v  $
 * 
 *    Rev 1.18   Nov 06 2017 09:54:12   RJamloki
 * Added MICROC ID to every Actuator ID’s Validation
 * 
 *    Rev 1.17   Oct 09 2017 15:33:22   RJamloki
 * added CurrentSetup.Actuator=MICROC in if statement that, evaluate actuator id's
 * 
 *    Rev 1.16   16 Mar 2015 05:48:06   rjamloki
 * Moved INPUT_CONFIRM_REJECT test to limits.cpp
 * 
 *    Rev 1.15   11 Mar 2015 09:14:36   amaurya
 * INPUT_REJECT_ALARM changed to INPUT_CONFIRM_REJECT.
 * 
 *    Rev 1.14   11 Feb 2015 06:33:24   amaurya
 * changes in function SelectCollapseWeldSequence for reject confirm input
 * 
 *    Rev 1.13   08 Jan 2015 03:18:18   AnPawar
 * printf removed
 * 
 *    Rev 1.12   18 Aug 2014 01:36:02   rjamloki
 * Added MICRO support
 * 
 *    Rev 1.11   28 Jul 2014 12:36:36   rjamloki
 * psos.h removed
 * 
 *    Rev 1.10   09 Jul 2014 10:42:04   rjamloki
 * SvInterlock renamed to PartClamp
 * 
 *    Rev 1.9   11 Jun 2014 11:17:20   rjamloki
 * removed and cleaned up redundant globals
 * 
 *    Rev 1.8   21 May 2014 10:51:48   rjamloki
 * Changes related to Weld Trigger by Distance
 * 
 *    Rev 1.7   21 May 2014 02:50:50   rjamloki
 * extern variables clean up
 * 
 *    Rev 1.6   26 Mar 2014 12:01:38   rjamloki
 * printf added for debugging.
 * 
 *    Rev 1.5   06 Mar 2014 11:03:44   rjamloki
...
/*------  Here we turn on some sonics  ------*/
	...
	if(RunningPreset.WeldTrigger == TRIGGERBY_FORCE){
	   ...
	   WeldSequence[i++] = &SonicsOn3BDist;
	   WeldSequence[i++] = &SonicsOn6Dist;
	}

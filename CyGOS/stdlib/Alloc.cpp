// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/stdlib/Alloc.cpp_v   1.3   14 Apr 2014 07:12:54   rjamloki  $
//
...
void CheckMemory(char * message, char * param)
{
	pprintf(message, param);
	if (!MemoryCheck())
	{
		CRASH("memory");
	}

// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/stdlib/String.cpp_v   1.5   06 Oct 2014 06:52:18   AnPawar  $
//
...
/*
 * Finds c in p up to n
 */
char * strnchr(const char *p, char c, int n)
{
	if (!p)
		return (0);

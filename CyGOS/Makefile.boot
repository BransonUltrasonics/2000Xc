# $Header: /ProductionCyGOS/CyGOS/Makefile.boot,v 1.1 2010/05/09 01:01:47 Aare Exp $
#
...
#
# This is the standard make file to include in the MultiBoot Makefile.
...
DLD = $(CyGOS)/MultiBoot-$(BOARD).ld
LIB = $(CyGOS)/libRTOS-$(BOARD).a
...
$(ELF) : $(STARTOBJ) $(OBJ) $(LIB)
	$(LD) $(LDOPT) -L$(OBJ_DIR) -L$(CyGOS) -o $@ $^ -lgcc -T $(DLD) -Map $(PRJ)-$(BOARD).map

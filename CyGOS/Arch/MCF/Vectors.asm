| $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/Arch/MCF/Vectors.asm_v   1.3   11 Dec 2014 08:31:06   AnPawar  $
|
...
_cache_flush:
				movec %D7, %CACR	|Set bits 14,20,28,12 as 1010 for CPUSHL     Enhancements
				cpushl %bc, (%A0)	|Push data, clear instruction

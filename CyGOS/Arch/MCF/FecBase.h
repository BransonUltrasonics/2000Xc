// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/Arch/MCF/FecBase.h_v   1.3   14 Apr 2014 07:28:10   rjamloki  $
//
...
protected:
	enum Configuration
	{
		RxBufferSize = 1520, nRxBD = 1024, nTxBD = 1024, StackSize = 256,
	};
public:
...
protected:
	...
	bool DebounceLinkStatus(bool NewStatus);
	FecMode mode;
	/**

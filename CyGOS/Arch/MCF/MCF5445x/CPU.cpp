// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/Arch/MCF/MCF5445x/CPU.cpp_v   1.3   14 Apr 2014 07:32:48   rjamloki  $
//
...
void CPU::SetupChipSelect(int cs, int wait, int width, volatile void * addr)
{
 ...
 * <li>Set exception handler in the RAM table to the provided handler function.
 * Function must be regular C function (or static member function).
...
{
	__VECTOR_RAM[32 + 0] = (long) TaskSwitch;
}

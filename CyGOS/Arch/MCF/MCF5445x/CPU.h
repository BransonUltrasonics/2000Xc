// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/Arch/MCF/MCF5445x/CPU.h_v   1.3   14 Apr 2014 07:32:46   rjamloki  $
//
...
public:
	...
	static void SetupChipSelect(int cs, int wait, int width, volatile void * addr);

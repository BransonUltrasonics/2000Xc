// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/Arch/MCF/MCF5445x/Terminal.cpp_v   1.7   23 Apr 2014 13:46:10   akaushal  $
//
...
void Terminal::Init()
{
	...
	case 0x0101: // Special case, UART1 on SSI port for 256-pin packages
		...
		break;
	case 0x0002: // UART2 using DMA timers
		MCF_PAD_PAR_TIMER &= 0x0F;
		MCF_PAD_PAR_TIMER |= 0x50;
		break;
	default:

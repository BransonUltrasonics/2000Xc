// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/Arch/MCF/MCF5445x/Exception.cpp_v   1.3   14 Apr 2014 07:33:28   rjamloki  $
//
...
void Exception::DefaultHandler(int vector, void * frame)
{
	...
	case 2:
		...
		//Log::WriteEventLog(EVENT_FAULT_ERROR, (unsigned short)MCF5XXX_RD_SF_FS(frame), (unsigned short)MCF5XXX_SF_PC(frame), vector);

		//Log::WriteEventLog(EVENT_FAULT_ERROR, (unsigned short)(MCF5XXX_SF_PC(frame) >> 16), (unsigned short)MCF5XXX_SF_PC(frame), vector);
	...
	case 24:
		...
		pprintf("Spurious Interrupt -- PC = %#08X\n", MCF5XXX_SF_PC(frame));
			pprintf("Masks  %08X %08X %08X %08X\n", MCF_INTC0_IMRH,
					MCF_INTC0_IMRL, MCF_INTC1_IMRH, MCF_INTC1_IMRL);
			pprintf("Status %08X %08X %08X %08X\n", MCF_INTC0_IPRH,
					MCF_INTC0_IPRL, MCF_INTC1_IPRH, MCF_INTC1_IPRL);
		return;
	case 25:
	case 26:
	case 27:

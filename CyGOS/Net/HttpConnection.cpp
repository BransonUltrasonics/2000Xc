// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/Net/HttpConnection.cpp_v   1.6   28 Nov 2014 08:09:28   rjamloki  $
//
...
#define MAX_UPLOAD_LENGTH_BIN 0x800000 + 1024//4096K + Extra HttpPacket plus checksum
#define MAX_UPLOAD_LENGTH_TAR 0x5C0000 + 1024//5888K + Extra HttpPacket
...
char * errorHtml1 =
		...
		"<form name=\"temp_form\" method=\"post\" action=\"SunriseFirmwareUpload32923646.html\">"
		"<input type=\"hidden\" name=\"lang\" id=\"lang\" value=\"\" />"
		"<input type=\"hidden\" name=\"userid1\" id=\"userid1\" value=\"\" />"
		"</form>";

char * errorHtml2 =
		"<input type=\"button\" value=\"Back\" onclick = \"GetLanguageAndUserID('SunriseFirmwareUpload32923646.html')\"/>"
		"</body>"
		"</html>";

char * errorHtml3 = "<html><head><title>Firmware Upload</title></head>"

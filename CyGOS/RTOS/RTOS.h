// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/RTOS/RTOS.h_v   1.4   14 Apr 2014 07:15:08   rjamloki  $
//
...
public:
	...
	static Task** Gettaskloadinformation();
	/**
	...
	static int GetCurrentTaskPriority()
	{
		if(taskCurrent)
			return taskCurrent->priority;
		return 0;
	}
	...
	static void SetTickHandler(void (*handler)());
protected:

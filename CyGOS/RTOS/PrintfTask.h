// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/RTOS/PrintfTask.h_v   1.3   05 Mar 2014 13:58:44   rjamloki  $
//
...
public:
	...
	static void SetEthDebugFifo(Fifo<char> * F)
	{
		PrintfTaskPtr->EthDebugFifo = F;
	}
	static PrintfTask * PrintfTaskPtr;
	Fifo<char> * EthDebugFifo;
protected:
	void Run();
	/**

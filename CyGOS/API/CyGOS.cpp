// $Header:   D:/databases/VMdb/archives/Sunrise/Weld Controller/2000XWCProj/CyGOS/API/CyGOS.cpp_v   1.5   14 Apr 2014 07:47:00   rjamloki  $
//
...
{
	RTOS::GetCurrentTask()->DelayMs(ms);
}
